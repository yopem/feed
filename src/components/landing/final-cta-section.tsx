    ...
    <section className="bg-muted/30 py-16 sm:py-20 md:py-28">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          <div className="from-background to-muted/30 relative overflow-hidden rounded-xl border bg-gradient-to-br p-6 text-center shadow-sm sm:rounded-2xl sm:p-8 md:p-12">
