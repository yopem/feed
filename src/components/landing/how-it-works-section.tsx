...
export default function HowItWorksSection() {
  ...
  return (
    <section
      className="bg-muted/30 border-border border-b-2 py-16 sm:py-20 md:py-28"
                ...
                <div key={step.number} className="relative">
                  <div className="flex flex-col items-center text-center">
                    <div className="relative mb-4 sm:mb-6">
                      <div className="bg-background border-border flex h-14 w-14 items-center justify-center rounded-2xl border-2 shadow-[2px_2px_0_0_hsl(var(--foreground))] sm:h-16 sm:w-16">
                        <Icon
                          className="text-foreground h-6 w-6 sm:h-7 sm:w-7"
                          aria-hidden="true"
                        />
                      </div>
                      <div className="bg-muted text-muted-foreground border-border absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full border-2 text-xs font-bold sm:h-6 sm:w-6">
                        {step.number}
                      </div>
                    </div>
