    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <article className="mx-auto max-w-3xl px-4 py-6 md:px-6 md:py-8 lg:px-8">
          ...
          {article.content ? (
            <div className="bg-card neo-border neo-shadow rounded-lg p-4 md:rounded-xl md:p-6 lg:p-8">
              <div
            ...
            <div className="bg-muted/30 neo-border neo-shadow rounded-lg p-6 text-center md:rounded-xl md:p-8">
